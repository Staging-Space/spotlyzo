@php
    $id = 'user.accounts.incoming-bookings';
    $title = 'Incoming Bookings | Accounts | User';
@endphp
    ...
    <section class="page-title page-title-bottom bg-holder bg-overlay-black-50" style="background: url({{ asset('images/breadcrumb.jpg') }});">
        <div class="container">
            <div class="row position-relative">
                <div class="col-lg-12">
                    <h1 class="text-white">Incoming Bookings</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li aria-current="page" class="breadcrumb-item active">Incoming Bookings</li>
                        </ol>
                    </nav>
                </div>
            </div>
